# This is a custom 1-1 character map for dealing with Python2->3's unicode-related transition.
# There's probably a better way of handling this, but I don't know it.
